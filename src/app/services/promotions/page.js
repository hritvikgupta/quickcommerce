    ...
    <div className="max-w-6xl mx-auto grid grid-cols-1 min-h-[550px] md:grid-cols-2 gap-8 items-center">
      ...
      <div>
        <h1 className="text-4xl text-black md:text-5xl font-bold mb-4">
          Increase Your Sale With Promotion And Offers For Your <span className="text-green-600">Quick Commerce Store</span>
        </h1>
        <p className="text-xl text-black mb-8">
          <span className="font-bold text-green-800">Pick A Plan Starting Rs 499 Per Month</span> and get started with a seamless quick commerce experience. Reach new customers, enhance your brand visibility, and offer customizable notifications to customers.
        </p>
      ...
      <div className="flex justify-center">
        <Image
          src="/images/promotion.png" // Replace with your image path
