        ...
        <div className="relative z-10 text-center md:text-left">
          <div className="space-y-6">
            <h1 className="text-3xl sm:text-4xl md:text-5xl text-gray-400 font-bold leading-tight">
              Increase Your Sale With Promotion And Offers For Your{" "}
            ...
            <div className="bg-gradient-to-r from-green-50 to-white p-6 rounded-xl border border-green-100">
              <p className="text-lg sm:text-xl text-gray-700 leading-relaxed">
                <span className="font-bold text-green-800 text-2xl block mb-3">
                  Pick A Plan Starting Rs 499 Per Month
                </span>
                Get started with a seamless quick commerce experience. Reach new customers, 
                enhance your brand visibility, and offer customizable notifications to customers.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 mt-8">
              <div className="bg-white p-4 rounded-lg shadow-sm">
                <div className="font-semibold text-green-800">Custom Promotions</div>
                <div className="text-sm text-gray-600">Tailored to your needs</div>
              </div>
              <div className="bg-white p-4 rounded-lg shadow-sm">
                <div className="font-semibold text-green-800">Smart Notifications</div>
                <div className="text-sm text-gray-600">Reach customers effectively</div>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="relative">
                ...
                <div className="relative">
                  <Image
                    ...
                    alt="InstaMart Marketing Partner"
                    width={1000}
                    height={1000}
              ...
              <div className="text-center md:text-left">
                ...
                <div className="mt-8 space-y-3">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-gray-700">₹2000 Free Marketing Credit</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <svg className="w-5 h-5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                    </svg>
                    <span className="text-gray-700">Targeted Customer Reach</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <svg className="w-5 h-5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                ...
                <div className="grid grid-cols-2 gap-4 mt-8">
                  <div className="text-center p-4 bg-green-50 rounded-lg">
                    ...
                    <div className="text-sm text-gray-600">Average Sales Boost</div>
                  </div>
                  <div className="text-center p-4 bg-green-50 rounded-lg">
                    <div className="text-2xl md:text-3xl font-bold text-green-600">2000+</div>
